...
hypothetical: an earlier, unpublished draft of this work did exactly that, at a cost
of $0.25$ AUROC and a confidently wrong explanation of the resulting failure. Second,
...
of compromises leaving no trace evidence lies between $0$ and $0.044$ depending on
how visibility is defined, putting the bound at or above $0.958$, because the
benchmark delivers payloads through tool outputs a successful injection must have
read. The ceiling is an artefact of benchmark construction rather than a limit of
the problem---a negative result about the field's evaluation practice, and the
finding I expect to be most useful to others. It also led me to withdraw a claim an
earlier draft made, that a published figure exceeded this corpus's information
limit; that was an artefact of the measurement convention. Fourth, it documents a label-polarity
