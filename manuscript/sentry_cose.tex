...
earlier, unpublished draft of this work, where it cost $0.25$ AUROC on the
composite score of Section~\ref{sec:ablation} and produced an explanation we had
written up and believed, which was wrong. Second, we show that action-side evidence is complementary rather than redundant:
over $90$ genuinely compromised trajectories from two agents, adding two
action-side audits to the instruction signal raises $\mathrm{AUROC}$ from $0.937$
to $0.954 \pm 0.003$ (paired $t = 4.9$ over ten calibration draws) and---the effect
that matters more for deployment---cuts the across-draw standard deviation of
recall at a fixed false-alarm budget from $\pm 0.357$ to $\pm 0.005$. The mean
recall gain, $0.709 \to 0.918$, is itself within that baseline variability and we do
not claim it as significant. Third, we measure where trace evidence lives and
report a caution about benchmark design: the observation channel is close to
saturated on AgentDojo because it delivers payloads through tool outputs a
successful injection must have read, so corpora of this shape cannot exhibit a
compromise that is invisible to a trace monitor. We deliberately decline to turn
this into an information-theoretic ceiling, and explain why an earlier version of
this work was wrong to do so. Fourth, we document a
...
Remark~\ref{rem:noceiling} why we withdrew such a bound from an earlier version of
this work. The durable consequence is a benchmark-design point: corpora of this
...
held-out negatives. Because only multiples of $1/n$ are attainable and the fused
statistic is discrete, a nominal target is not reached exactly; the realised rate
at the $5\%$ target is given, and rows therefore sit at \emph{different} operating
points, so the TPR columns are not like-for-like across rows whereas AUROC is. The
final column repeats the exercise at $3.66\%$, the operating point
\citet{wang2025agentarmor} report, for readers who want that comparison---though
Section~\ref{sec:metrics} explains why we do not present it as a head-to-head.
SENTRY-Fuse in bold.}
\label{tab:fused}
\footnotesize
...
\begin{tabular}{@{}lcccc@{}}
\toprule
Detector & AUROC & TPR@$5\%$ & realised FPR & TPR@$3.66\%$ \\
\midrule
\multicolumn{5}{@{}l}{\emph{GPT-4o-mini: 72 compromised, 24 held-out benign}} \\
S3 instruction-likeness only    & $0.951 \pm 0.026$ & $0.661 \pm 0.433$ & $1.2\%$ & $0.472 \pm 0.472$ \\
S4 action audit only            & $0.900 \pm 0.039$ & $0.267 \pm 0.407$ & $0.4\%$ & $0.178 \pm 0.356$ \\
S5 sink provenance only         & $0.868 \pm 0.019$ & $0.164 \pm 0.328$ & $0.4\%$ & $0.082 \pm 0.246$ \\
S1 $+$ S2 behavioural           & $0.530 \pm 0.058$ & $0.101 \pm 0.076$ & $3.8\%$ & $0.040 \pm 0.050$ \\
S3 $+$ S4                       & $0.981 \pm 0.009$ & $0.914 \pm 0.040$ & $2.5\%$ & $0.803 \pm 0.269$ \\
\textbf{SENTRY-Fuse (S3--S5)}   & $\mathbf{0.985 \pm 0.003}$ & $\mathbf{0.956 \pm 0.006}$ & $2.9\%$ & $\mathbf{0.899 \pm 0.063}$ \\
all five signals                & $0.973 \pm 0.013$ & $0.932 \pm 0.053$ & $3.3\%$ & $0.743 \pm 0.290$ \\
\midrule
\multicolumn{5}{@{}l}{\emph{DeepSeek-V4-Flash: 18 compromised, 25 held-out benign}} \\
S3 instruction-likeness only    & $0.850 \pm 0.021$ & $0.467 \pm 0.381$ & $2.4\%$ & $0.078 \pm 0.233$ \\
S4 action audit only            & $0.781 \pm 0.017$ & $0.000 \pm 0.000$ & $0.0\%$ & $0.000 \pm 0.000$ \\
S5 sink provenance only         & $0.648 \pm 0.027$ & $0.117 \pm 0.178$ & $0.8\%$ & $0.039 \pm 0.117$ \\
S1 $+$ S2 behavioural           & $0.389 \pm 0.080$ & $0.000 \pm 0.000$ & $2.4\%$ & $0.000 \pm 0.000$ \\
S3 $+$ S4                       & $0.842 \pm 0.006$ & $0.778 \pm 0.000$ & $4.0\%$ & $0.683 \pm 0.230$ \\
\textbf{SENTRY-Fuse (S3--S5)}   & $\mathbf{0.832 \pm 0.010}$ & $\mathbf{0.767 \pm 0.033}$ & $4.0\%$ & $\mathbf{0.539 \pm 0.184}$ \\
all five signals                & $0.807 \pm 0.032$ & $0.661 \pm 0.118$ & $3.6\%$ & $0.478 \pm 0.263$ \\
\midrule
\multicolumn{5}{@{}l}{\emph{Pooled: 90 compromised, 47 held-out benign}} \\
S3 instruction-likeness only    & $0.937 \pm 0.012$ & $0.709 \pm 0.357$ & $2.8\%$ & $0.598 \pm 0.394$ \\
S4 action audit only            & $0.863 \pm 0.030$ & $0.000 \pm 0.000$ & $0.0\%$ & $0.000 \pm 0.000$ \\
S5 sink provenance only         & $0.812 \pm 0.015$ & $0.000 \pm 0.000$ & $0.0\%$ & $0.000 \pm 0.000$ \\
S1 $+$ S2 behavioural           & $0.557 \pm 0.065$ & $0.038 \pm 0.048$ & $3.8\%$ & $0.011 \pm 0.020$ \\
S3 $+$ S4                       & $0.953 \pm 0.005$ & $0.898 \pm 0.020$ & $3.8\%$ & $0.871 \pm 0.045$ \\
\textbf{SENTRY-Fuse (S3--S5)}   & $\mathbf{0.954 \pm 0.003}$ & $\mathbf{0.918 \pm 0.005}$ & $4.0\%$ & $\mathbf{0.884 \pm 0.071}$ \\
all five signals                & $0.948 \pm 0.012$ & $0.886 \pm 0.070$ & $3.8\%$ & $0.808 \pm 0.076$ \\
\bottomrule
\end{tabular}
\end{table}
...
signal alone reaches $\mathrm{AUROC} = 0.937$; adding the two action-side signals
takes this to $0.954$, a paired difference of $+0.017 \pm 0.011$ over the ten
calibration draws ($t = 4.9$, significant at the $5\%$ level). The gain is not
explained by the action signals being individually strong---alone they reach
$0.863$ and $0.812$ AUROC and no recall whatever at this budget---so they
contribute cases the observation signal misses rather than duplicating it. We rest
this claim on AUROC because it does not depend on where each row's threshold
happens to fall; the corresponding recall difference, $0.709 \to 0.918$, is
\emph{not} significant against the baseline's own spread ($+0.209 \pm 0.372$,
$t = 1.8$), and we say so rather than quoting the difference of the means.

The third signal deserves a sharper statement than the second. Sink provenance
(S5) adds $+0.020 \pm 0.017$ recall over S3$+$S4 ($t = 3.7$, significant) but only
$+0.0005 \pm 0.0044$ AUROC ($t = 0.4$, indistinguishable from zero), and on the
DeepSeek corpus it makes AUROC slightly \emph{worse} ($0.832$ against $0.842$). Its
case therefore rests on recall at a fixed budget, not on ranking quality, and a
reader who prefers AUROC as the figure of merit should regard SENTRY-Fuse as
S3$+$S4 with S5 an optional third channel.

Second, \textbf{fusion buys stability as well as power}, and this is the more
robust of the two effects. The instruction signal's standard deviation at a fixed
budget is $\pm 0.381$ on GPT-4o-mini and $\pm 0.357$ pooled: its recall at a low
false-alarm rate is close to unpredictable across calibration draws. SENTRY-Fuse
reduces this to $\pm 0.006$ and $\pm 0.005$---nearly two orders of
magnitude---which is the difference between a detector one can deploy at a stated
operating point and one that cannot be given a stated operating point at all.
Unlike the mean gain, this difference is far outside sampling noise.
...
not. Every compromised trajectory contains at least a five-word contiguous span
...
Second, at the stricter end the resulting bound ($0.916$) falls below the
true-positive rate we ourselves measure ($0.918$ pooled). A bound that the
measurement violates is not a useful bound: either the indistinguishability
assumption such an argument needs is false on this corpus, or the criterion is too
strict to represent evidence availability. Both readings undercut the exercise.
...
both corpora and the action channel is not, which is why sink provenance
contributes recall rather than replacing the observation signal. We report these
...
that limitation in mind: the $8\%$ of compromises we miss are ones we failed to
score, not ones that were hidden from us.
...
$8\%$ of compromises we miss are ones we failed to score rather than ones that were
hidden.
