...
\EndFor
\State $\tau \gets$ the $k$-th largest of $\{S(\Tcal) : \Tcal \in \Dcal_{\mathrm{test}}\}$, $k = \lfloor \alpha |\Dcal_{\mathrm{test}}| \rfloor$ \Comment{in sample; Section~\ref{sec:metrics}}
...
$0.0\%$ to $4.4\%$ against a $5\%$ target rather than sitting at $k/n$. Second, we
...
That inflated S5's apparent standalone recall from $0.000$ to $0.220$. $\tau$-bench
