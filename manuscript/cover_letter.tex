...
injection-\emph{attempt} detection, reports a full ablation---including three
signals I implemented and rejected---and is explicit about its limitations. To
my knowledge this is the first anytime-valid change-detection study on
