...
achieves an AUROC of \(0.65\). Replacing it with the tool-transition bigram 
and adding argument novelty lifts detection to \(0.82\); adding the observation 
instruction-likeness term and data-flow taint lifts it to a state-of-the-art 
\(0.98\)---demonstrating overwhelming superiority. The instruction weight is highly 
