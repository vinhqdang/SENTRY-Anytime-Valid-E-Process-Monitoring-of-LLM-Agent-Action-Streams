...
\subsection{Detection performance}\label{sec:detection}
...
These three cover the qualitative regimes; the trace in
Figure~\ref{fig:traces} is an instance of case (i).
